...
import { Box, Grid, IconButton, List, ListItem, ListItemIcon, ListItemText, Typography, colors } from "@mui/material";
...
const ViewTicketDialog: TViewTicketDialogFC = ({ handleClose, selectedTicket, handleCreate, handleDelete }) => {
  ...
  return (
    <Modal title="View Details" handleClose={handleClose} opened size="xxxxl">
        ...
        <Grid item md={7}>
          ...
          <Box mt={2}>
            ...
            {selectedTicket?.closeAt && (
              <Typography variant="body2" component="p">
                Closed At : {moment(selectedTicket?.closeAt).format(APP_DATE_TIME_FORMAT)}
              </Typography>
            )}
          </Box>
        ...
        <Grid item md={5}>
          <FlexBox justifyContent="space-between">
            <Typography variant="h6" component="h1" fontWeight="bold">
              The answer from supporter
            </Typography>
            <Typography variant="caption" component="span">
              {moment(selectedTicket?.answerAt).format(APP_DATE_TIME_FORMAT)}
            </Typography>
          </FlexBox>
          <Typography lineHeight={2} mt={2} variant="caption" component="p">
