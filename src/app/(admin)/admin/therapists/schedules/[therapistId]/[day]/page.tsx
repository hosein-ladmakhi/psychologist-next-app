...
import {
  getSchedulesBasedOnTherapistAndDay,
  getTherapistById,
} from '@/services/therapist.service';

const TherapistScheduleByTherapistIdPage: FC<
  ITherapistScheduleByTherapistIdPageProps
> = async ({ params }) => {
  const schedules = await getSchedulesBasedOnTherapistAndDay(
    params.therapistId,
    params.day,
  );
